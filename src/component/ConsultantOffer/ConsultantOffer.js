            ...
            <div className="card-body pb-0 mt-5">
              ...
              <div>
                ...
                <div>
                  ...
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>Dear Ms. Manikanta,</strong></p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>We are pleased to offer you an employment at Test Yantra Software Solutions (India) Pvt. Ltd. You have been offered as a <strong>Consultant - Software Engineer</strong> in our Bangalore office. We extend this offer, and the opportunity it represents, with great confidence in your abilities.&nbsp;</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>Your date of joining to Test Yantra would be <strong>1<sup>st</sup> May 2019</strong>. Your Initial Posting will be at<strong> Bangalore, India. </strong>However, your services are transferable to any other place or office of the Company or to any subsidiary or associate company; whether now existing or still to be formed. Such transfer / deputation will be in accordance with the company’s rules being in force at the time.</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
            ...
            <div className="card-body pb-0 mt-5">
              ...
              <div>
                ...
                <div>
                  ...
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>&nbsp;</p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}>I agree to accept the conditional offer and employment on the above-mentioned terms and conditions. I’ll report for duty on<strong> 13th May 2019</strong></p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
                  <p style={{ textAlign: 'justify', paddingLeft: 30 }}><strong>&nbsp;</strong></p>
